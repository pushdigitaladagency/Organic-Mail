  ...
  <tr>
    <td align="center">
      ...
      <table width="600" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" style="margin:20px 0; border-radius:8px; overflow:hidden;">
        ...
        <!-- Banner -->
        <tr>
          <td style="background:#1f3a25;text-align: center;padding: 20px;">
            
            <img 
              src="http://organicheritage.store/images/Logo.svg" 
              alt="Organic Heritage" 
              style="height:80px; width:80px;"
            >

            <h2 style="margin-top:-5px; color:#ffffff; font-size:18px;">
              New Business Query
            </h2>
        ...
        <tr>
          <td style="padding:20px;">
            ...
            <table 
              ...
              cellspacing="0" 
              border="0" 
              style="background:#f1fff1; border-left:4px solid #1F3A25; border-radius:5px; margin-top:20px;"
            >
              <tr>
        ...
        <tr>
          <td 
            ...
            "
          >
            <span style="color:#43EB01; font-weight:bold;">Organic Heritage</span>
            &mdash;
